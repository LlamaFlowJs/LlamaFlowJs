---
title: LlamaFlow v0.3.0
description: This is my first post on Docusaurus.
slug: welcome-LlamaFlow-v0.3
authors:
  - name: Alex Yang
    title: LlamaFlow maintainer, Node.js Member
    url: https://github.com/himself65
    image_url: https://github.com/himself65.png
tags: [llamaflow, agent]
hide_table_of_contents: false
---

- [What's new in LlamaFlow v0.3.0](#whats-new-in-LlamaFlow-v030)
- [Improvement in LlamaFlow v0.3.0](#improvement-in-LlamaFlow-v030)
- [What's the next?](#whats-the-next)

## What's new in LlamaFlow v0.3.0

## Agents

In this release, we've not only ported the Agent module from the LlamaFlow Python version but have significantly
...
```ts
import { AgentRunner, OpenAI } from "llamaflow";
...
import { OpenAIAgent } from "llamaflow";
import type { ChatMessage } from "llamaflow/llm/types";
...
## Improvement in LlamaFlow v0.3.0
...
In addition to Node.js, LlamaFlow now offers enhanced support for Next.js, Deno, and Cloudflare Workers, making it
more versatile across different platforms.

For now, you can install llamaflow and directly import it into your existing Next.js, Deno or Cloudflare Worker project
**without any extra configuration**.

#### [Deno](https://deno.com/)

You can use LlamaFlow in Deno by installation through JSR:

```sh
jsr add @llamaflow/core
```
...
You can use LlamaFlow with Node.js output to enable full Node.js support with React.
...
As we continue to develop LlamaFlow, our focus remains on providing more comprehensive and powerful tools for
creating custom agents.

### Align with the Python `llama-index`

We aim to align LlamaFlow with the Python version to ensure API consistency and ease of use for developers familiar
...
We are exploring innovative ways to create tools for agents. The `@llamaflow/tool` library allows you to transform any
...
import { getTools } from "@llamaflow/tool";
...
```ts
// next.config.js
const withTool = require("@llamaflow/tool/next");
...
agents. For more information and updates, visit the @llamaflow/tool repository.

This release of LlamaFlow v0.3.0 marks a significant step forward in our journey to provide developers with robust,
flexible tools for building advanced agents. We are excited to see how our community utilizes these new capabilities to
create innovative solutions and look forward to continuing to support and enhance LlamaFlow in future updates.
