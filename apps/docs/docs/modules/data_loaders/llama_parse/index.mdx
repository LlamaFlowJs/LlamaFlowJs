...
See [LlamaParseReader.ts](https://github.com/run-llama/llamaflowTS/blob/main/packages/llamaflowjs/src/readers/LlamaParseReader.ts) for a list of supported file types:
