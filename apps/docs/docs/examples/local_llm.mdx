...
LlamaFlow supports OpenAI and [other remote LLM APIs](other_llms). You can also run a local LLM on your machine!
...
To tell LlamaFlow to use a local LLM, use the `Settings` object:
...
If you're doing retrieval-augmented generation, LlamaFlow will also call out to OpenAI to index and embed your data. To be entirely local, you can use a local embedding model like this:
