...
import { baseToolWithCallSchema } from "@llamaflowjs/core/schema";
import { ReadableStream } from "@llamaflowjs/env";
import { z } from "zod";
...
export function validateAgentParams<AI extends LLM>(
  ...
  if ("tools" in params) {
    ...
    // todo: check `params.toolRetriever` when migrate to @llamaflowjs/core
  }
}
