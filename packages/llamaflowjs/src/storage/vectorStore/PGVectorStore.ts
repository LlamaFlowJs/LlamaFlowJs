...
import type { BaseNode, Metadata } from "@llamaflowjs/core/schema";
import { Document, MetadataMode } from "@llamaflowjs/core/schema";
 ...
 * Note: Can't be used with data created using the Python version of the vector store (https://docs.llamaflowjs.ai/en/stable/examples/vector_stores/postgres.html)
 */
