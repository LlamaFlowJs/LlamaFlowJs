import type { MessageContentDetail } from "@llamaflowjs/core/llms";
import {
  ImageNode,
  MetadataMode,
  ModalityType,
  ...
  type BaseNode,
  type ImageType,
} from "@llamaflowjs/core/schema";
import { extractImage, extractSingleText } from "@llamaflowjs/core/utils";
