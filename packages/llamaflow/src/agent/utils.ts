...
import { baseToolWithCallSchema } from "@llamaflow/core/schema";
import { ReadableStream } from "@llamaflow/env";
import { z } from "zod";
...
export function validateAgentParams<AI extends LLM>(
  ...
  if ("tools" in params) {
    ...
    // todo: check `params.toolRetriever` when migrate to @llamaflow/core
  }
}
